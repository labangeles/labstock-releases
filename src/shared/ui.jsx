...
export const Ico = {
  ...
  Beaker:      ({s=18,c='currentColor'}) => (<svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M9 3h6v8l3.5 6a2 2 0 0 1-1.8 3H7.3a2 2 0 0 1-1.8-3L9 11V3"/><line x1="6.5" y1="6" x2="17.5" y2="6"/></svg>),
